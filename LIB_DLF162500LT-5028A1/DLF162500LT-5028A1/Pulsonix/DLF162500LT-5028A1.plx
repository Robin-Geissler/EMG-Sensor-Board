...
(library Library_1
	...
	(compDef "DLF162500LT-5028A1" (originalName "DLF162500LT-5028A1") (compHeader (numPins 4) (numParts 1) (refDesPrefix FL)
		...
		(attr "<Hyperlink>" "https://product.tdk.com/system/files/dam/doc/product/rf/rf/filter/catalog/rf_lpf_dlf162500lt-5028a1_en.pdf")
		(attr "<Component Height>" "0.4")
		(attr "<STEP Filename>" "DLF162500LT-5028A1.stp")
