...
/**
  ...
  */  
#define SD_CS_LOW()       HAL_GPIO_WritePin(SPI2_NCS1_GPIO_Port, SPI2_NCS1_Pin, GPIO_PIN_RESET)
#define SD_CS_HIGH()      HAL_GPIO_WritePin(SPI2_NCS1_GPIO_Port, SPI2_NCS1_Pin, GPIO_PIN_SET)
...
/**
  ...
  */
//#define SD_CS_PIN                                 GPIO_PIN_6 //GPIO_PIN_10
